...
// include: /tmp/tmpxk6lpt62.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'Steed.data';
      var REMOTE_PACKAGE_BASE = 'Steed.data';
...
var REMOTE_PACKAGE_SIZE = metadata['remote_package_size'];
    ...
    function runWithFS(Module) {
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_Steed.data');

      };
      Module['addRunDependency']('datafile_Steed.data');
    ...
    loadPackage({"files": [{"filename": "/test.png", "start": 0, "end": 58261}], "remote_package_size": 58261});

  })();

// end include: /tmp/tmpxk6lpt62.js
// include: /tmp/tmp1fl5haz_.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp1fl5haz_.js
// include: /tmp/tmpe13gfpj4.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpe13gfpj4.js
...
var ASM_CONSTS = {
  94808: () => { if (document.fullscreenElement) return 1; },  
 94854: () => { return Module.canvas.width; },  
 94886: () => { return parseInt(Module.canvas.style.width); },  
 94934: () => { document.exitFullscreen(); },  
 94961: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 95034: () => { if (document.fullscreenElement) return 1; },  
 95080: () => { return Module.canvas.width; },  
 95112: () => { return screen.width; },  
 95137: () => { document.exitFullscreen(); },  
 95164: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 95297: () => { return window.innerWidth; },  
 95323: () => { return window.innerHeight; },  
 95350: () => { if (document.fullscreenElement) return 1; },  
 95396: () => { return Module.canvas.width; },  
 95428: () => { return parseInt(Module.canvas.style.width); },  
 95476: () => { if (document.fullscreenElement) return 1; },  
 95522: () => { return Module.canvas.width; },  
 95554: () => { return screen.width; },  
 95579: () => { return window.innerWidth; },  
 95605: () => { return window.innerHeight; },  
 95632: () => { if (document.fullscreenElement) return 1; },  
 95678: () => { return Module.canvas.width; },  
 95710: () => { return screen.width; },  
 95735: () => { document.exitFullscreen(); },  
 95762: () => { if (document.fullscreenElement) return 1; },  
 95808: () => { return Module.canvas.width; },  
 95840: () => { return parseInt(Module.canvas.style.width); },  
 95888: () => { document.exitFullscreen(); },  
 95915: ($0) => { Module.canvas.style.opacity = $0; },  
 95953: () => { return screen.width; },  
 95978: () => { return screen.height; },  
 96004: () => { return window.screenX; },  
 96031: () => { return window.screenY; },  
 96058: () => { return window.devicePixelRatio; },  
 96094: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 96147: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 96198: () => { Module.canvas.style.cursor = 'none'; },  
 96235: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 96491: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 96542: () => { if (document.pointerLockElement) return 1; },  
 96589: () => { if (document.fullscreenElement) return 1; },  
 96635: () => { return window.innerWidth; },  
 96661: () => { return window.innerHeight; }
};
